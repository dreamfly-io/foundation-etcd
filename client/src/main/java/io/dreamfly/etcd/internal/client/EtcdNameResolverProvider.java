package io.dreamfly.etcd.internal.client;


import com.google.common.util.concurrent.ThreadFactoryBuilder;

import io.dreamfly.grpc.internal.nameresolver.GrpcAdvancedNameResolver;
...
/**
 * Provide standard gRPC NameResolver for etcd.
 */
public class EtcdNameResolverProvider extends NameResolverProvider {
    ...
    public NameResolver newNameResolver(URI targetUri, Attributes params) {
        ...
        return new GrpcAdvancedNameResolver(ETCD_SCHEME, authority, timerServiceResource, executorResource);
    }
}
